...
export default function useUpdateLeaveStatus() {
    const queryClient = useQueryClient();

    const updateLeaveStatus = async (formData) => {
        ...
        return await axios.post(
            `https://phaseii-backend.amanahhr.com/api/updateLeaveStatus`,
            formData,
            {
                headers: {
    ...
    return useMutation(updateLeaveStatus, {
        onSuccess: async () => {
